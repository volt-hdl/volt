...
// names (dut.aw_addr, dut.b_valid, ...) plus gpio_out / gpio_oe /
...
test "invalid address returns slverr" {
    ...
    dut.ar_valid = false;
    assert_eq(dut.r_resp, 0);
    assert_eq(dut.r_data, 0x50C00001);
    step(1);
